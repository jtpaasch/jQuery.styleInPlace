...
To see it in action, look at the [the demo](http://jtpaasch.github.com/jQuery.styleInPlace/), or try it on your local machine: download the zip or fork the project, then open index.html in a browser. 
