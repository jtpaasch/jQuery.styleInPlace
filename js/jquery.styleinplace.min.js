(function(a){a.fn.styleInPlace=function(p){var q={styles:"default",save:function(){return null}},p=a.extend(q,p),c,f,r=!1,n={},v=function(){r=!0;l();f.fadeIn(150,function(){l()})},w=function(){f.fadeOut(150,function(){r=!1;a(this).remove()})},l=function(){if(!r)return!1;var h=f.find(".style-in-place-lightbox-top-row"),b=f.find(".style-in-place-lightbox-middle-row"),d=f.find(".style-in-place-lightbox-bottom-row"),e=f.find(".style-in-place-lightbox-middle-row-left-column"),x=f.find(".style-in-place-lightbox-middle-row-center-column"),
g=f.find(".style-in-place-lightbox-middle-row-right-column"),m=c.position(),i=m.left,k=m.top,m=c.outerWidth(!0),l=c.outerHeight(!0);h.css("height",k);b.css("height",l);var j=i+m,k=h.width();j>k&&(k=j);j=a(window).width();j>k&&(k=j);h.css("width",k);b.css("width",k);d.css("width",k);e.css({width:i,height:l});x.css({width:m});g.css("width",k-(i+m));h=f.find(".style-in-place-lightbox-editor-pane").outerHeight();b=d.outerHeight();h>b&&d.css("height",h)},g=function(h,b){c.css(b,a.trim(h));n[b]=h;l();o()},
s=function(h,b){"inline"===c.css("display")&&c.css("display","inline-block");c.css(b,a.trim(h));n[b]=h;l();o()},t=function(h,b){var d=h.split(" ");if(1===d.length){var e=a.trim(d[0]);c.css(b+"-top",e);c.css(b+"-right",e);c.css(b+"-bottom",e);c.css(b+"-left",e)}else 2===d.length?(e=a.trim(d[0]),d=a.trim(d[1]),c.css(b+"-top",e),c.css(b+"-right",d),c.css(b+"-bottom",e),c.css(b+"-left",d)):4===d.length&&(c.css(b+"-top",a.trim(d[0])),c.css(b+"-right",a.trim(d[1])),c.css(b+"-bottom",a.trim(d[2])),c.css(b+
"-left",a.trim(d[3])));n[b]=h;l();o()},u=function(a){var b;b=""+(parseInt(c.css(a+"-top"))+"px ");b+=parseInt(c.css(a+"-right"))+"px ";b+=parseInt(c.css(a+"-bottom"))+"px ";return b+=parseInt(c.css(a+"-left"))+"px"},o=function(){a("#style-in-place-editor-pane-font-family").html(c.css("font-family"));a("#style-in-place-editor-pane-font-size").html(c.css("font-size"));a("#style-in-place-editor-pane-line-height").html(c.css("line-height"));a("#style-in-place-editor-pane-font-weight").html(c.css("font-weight"));
a("#style-in-place-editor-pane-font-style").html(c.css("font-style"));a("#style-in-place-editor-pane-text-decoration").html(c.css("text-decoration"));a("#style-in-place-editor-pane-text-transform").html(c.css("text-transform"));a("#style-in-place-editor-pane-color").html(c.css("color"));a("#style-in-place-editor-pane-text-align").html(c.css("text-align"));a("#style-in-place-editor-pane-width").html(c.css("width"));a("#style-in-place-editor-pane-height").html(c.css("height"));a("#style-in-place-editor-pane-margin").html(u("margin"));
a("#style-in-place-editor-pane-padding").html(u("padding"))},y=function(){a("#style-in-place-editor-pane-font-family").on("click",function(){j(a(this),{arial:"Arial, sans-serif",verdana:"Verdana, sans-serif",georgia:"Georgia, serif",times:"Times, serif"},{callback:g,parameters:"font-family"})});a("#style-in-place-editor-pane-font-size").on("click",function(){i(a(this),{callback:g,parameters:"font-size"})});a("#style-in-place-editor-pane-line-height").on("click",function(){i(a(this),{callback:g,parameters:"line-height"})});
